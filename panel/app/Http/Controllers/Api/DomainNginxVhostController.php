...
class DomainNginxVhostController extends Controller
{
    ...
    public function show(Request $request, Domain $domain): JsonResponse
    {
        ...
        $res = $this->engine->getSiteNginxVhost($domain->name);
        if (! empty($res['error'])) {
    ...
    public function update(Request $request, Domain $domain): JsonResponse
    {
        ...
        $res = $this->engine->updateSiteNginxVhost($domain->name, (string) $validated['content']);
        if (! empty($res['error'])) {
            return response()->json([
                'message' => (string) $res['error'],
                'path' => $res['path'] ?? null,
    ...
    public function revert(Request $request, Domain $domain): JsonResponse
    {
        ...
        $res = $this->engine->revertSiteNginxVhost($domain->name);
        if (! empty($res['error'])) {
            return response()->json([
                'message' => (string) $res['error'],
                'path' => $res['path'] ?? null,
