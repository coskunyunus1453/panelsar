    ...
    <div class="hv-container">
        <div class="flex flex-col gap-8 lg:flex-row lg:items-start lg:justify-between">
            ...
            <div class="grid grid-cols-2 gap-8 sm:grid-cols-3">
                <div>
                    <p class="mb-3 text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-500">{{ landing_t('footer.col_site') }}</p>
                ...
                <div>
                    <p class="mb-3 text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-500">{{ landing_t('footer.col_resources') }}</p>
                    <ul class="space-y-2 text-sm font-medium">
                ...
                <div class="col-span-2 sm:col-span-1">
                    <p class="mb-3 text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-500">{{ landing_t('footer.col_status') }}</p>
                    <p class="text-sm text-slate-600 dark:text-slate-400">{{ landing_t('footer.status_blurb') }}</p>
                </div>
            </div>
        </div>
    </div>
