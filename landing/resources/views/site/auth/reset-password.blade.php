<x-site.layout title="Yeni şifre" description="Şifrenizi belirleyin">
    <div class="hv-container max-w-md py-12">
        <div class="rounded-2xl border border-slate-200/90 bg-white/90 p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900/50">
            <h1 class="text-xl font-semibold text-slate-900 dark:text-slate-50">Yeni şifre</h1>
            <p class="mt-1 text-sm text-slate-600 dark:text-slate-400">Güçlü bir şifre seçin (en az 10 karakter; büyük/küçük harf ve rakam).</p>
            ...
            <form method="post" action="{{ route('password.store') }}" class="mt-6 space-y-4">
                ...
                <div>
                    <label for="password" class="block text-sm font-medium text-slate-700 dark:text-slate-300">Yeni şifre</label>
                ...
                <div>
                    <label for="password_confirmation" class="block text-sm font-medium text-slate-700 dark:text-slate-300">Yeni şifre (tekrar)</label>
